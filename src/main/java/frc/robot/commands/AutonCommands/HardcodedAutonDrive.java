...
public class HardcodedAutonDrive extends SequentialCommandGroup {
  /** Creates a new HardcodedAuton. */
  public HardcodedAutonDrive(DrivetrainSubsystem drivetrain, Pivot pivot, Elevator elevator, Shintake shintake) {
